...
data_path_dict = {
    0 : ["..\..\Background_data/" + file_path for file_path in listdir("..\..\Background_data/")],       #for each file in directory, identify 0 case
    1 : ["..\..\Audio_data/" + file_path for file_path in listdir("..\..\Audio_data/")]                  #for each file in directory, identify 1 case
}
...
df.to_pickle(r'..\Wake_word\Final_audio_data/audio_data.csv')                                             #forms a csv file