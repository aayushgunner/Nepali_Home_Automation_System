...
def record_audio_and_save(save_path, n_times=28):                                  #wakeword recording function
    ...
    for i in range(n_times):
        ...
        sd.wait()
        write(save_path + str(i) + "_3.wav", fs, myrecording)                         #save recording
...
def record_background_save(save_path, n_times=100):                                 #background audio
    ...
    for i in range(n_times):
        ...
        myrecording = sd.rec(int(seconds*fs), samplerate = fs, channels = 2)
        sd.wait()
        write(save_path + str(i) + "_1.wav", fs, myrecording)                         #save recording
        print("Next")
    pass
